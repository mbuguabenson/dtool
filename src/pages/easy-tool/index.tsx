...
const EasyTool = observer(() => {
    const { smart_trading, common, client, ui } = useStore();
    const { current_price, last_digit, ticks, stats_sample_size, setStatsSampleSize } = smart_trading;
    ...
    // Unified market data is now managed by SmartTradingStore's internal subscription
    // Components reactively observe 'smart_trading' state.
